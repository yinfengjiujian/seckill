 ...
 */
@Component
public class MailProducerImpl implements MQProducer {
        ...
        try {
            if (message instanceof Message){
               ...
               CorrelationData correlationData = new CorrelationData(msgId);
                mailRabbitTemplate.convertAndSend(mailRabbitTemplate.getRoutingKey(),message,correlationData);
            }else {
    ...
    public void sendDataToRabbitMQ(Object message, MessagePostProcessor messagePostProcessor) {
        try {
            if (message instanceof Message){
                ...
                String msgId = messageSend.getMessageProperties().getCorrelationId();
                CorrelationData correlationData = new CorrelationData(msgId);
                mailRabbitTemplate.convertAndSend(mailRabbitTemplate.getRoutingKey(),message,messagePostProcessor,correlationData);
            }else {
                mailRabbitTemplate.convertAndSend(message, messagePostProcessor);
            }
        } catch (AmqpException e) {
            logger.error(e.getMessage(), e);
        }
    ...
    public void sendDataToRabbitMQ(Object message, MessagePostProcessor messagePostProcessor, CorrelationData correlationData) {
        try {
            mailRabbitTemplate.convertAndSend(message, messagePostProcessor, correlationData);
        } catch (AmqpException e) {
            logger.error(e.getMessage(), e);
        }
    }
    ...
    public void sendDataToRabbitMQ(String routingKey, Object message) {
        try {
            if (message instanceof Message){
                ...
                String msgId = messageSend.getMessageProperties().getCorrelationId();
                CorrelationData correlationData = new CorrelationData(msgId);
                mailRabbitTemplate.convertAndSend(routingKey,message,correlationData);
            }else {
                mailRabbitTemplate.convertAndSend(routingKey, message);
            }
        } catch (AmqpException e) {
            logger.error(e.getMessage(), e);
        }
    ...
    public void sendDataToRabbitMQ(String routingKey, Object message, MessagePostProcessor messagePostProcessor) {
        try {
            if (message instanceof Message){
                ...
                String msgId = messageSend.getMessageProperties().getCorrelationId();
                CorrelationData correlationData = new CorrelationData(msgId);
                mailRabbitTemplate.convertAndSend(routingKey,message,messagePostProcessor,correlationData);
            }else {
                mailRabbitTemplate.convertAndSend(routingKey, message, messagePostProcessor);
            }
        } catch (AmqpException e) {
            logger.error(e.getMessage(), e);
        }
    ...
    public void sendDataToRabbitMQ(String exchange, String routingKey, Object message) {
        try {
            if (message instanceof Message){
                ...
                mailRabbitTemplate.convertAndSend(exchange, routingKey, message);
            }
        } catch (AmqpException e) {
            logger.error(e.getMessage(), e);
        }
    ...
    public void sendDataToRabbitMQ(String exchange, String routingKey, Object message, CorrelationData correlationData) {
        try {
            mailRabbitTemplate.convertAndSend(exchange, routingKey, message, correlationData);
        } catch (AmqpException e) {
            logger.error(e.getMessage(), e);
        }
    }
    ...
    public void sendDataToRabbitMQ(String exchange, String routingKey, Object message, MessagePostProcessor messagePostProcessor) {
        try {
            mailRabbitTemplate.convertAndSend(exchange, routingKey, message, messagePostProcessor);
        } catch (AmqpException e) {
            logger.error(e.getMessage(), e);
        }
    }
    ...
    public void sendDataToRabbitMQ(String exchange, String routingKey, Object message, MessagePostProcessor messagePostProcessor, CorrelationData correlationData) {
        try {
            mailRabbitTemplate.convertAndSend(exchange, routingKey, message, messagePostProcessor, correlationData);
        } catch (AmqpException e) {
            logger.error(e.getMessage(), e);
        }
    }
