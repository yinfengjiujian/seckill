 ...
 */
public class PhoneConsumerListener implements ChannelAwareMessageListener {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    public void onMessage(Message message, Channel channel) throws Exception {
        try {
            logger.info("phone--消费开始----->consumer--:" + message.getMessageProperties() + ":" + new String(message.getBody(),"UTF-8"));
